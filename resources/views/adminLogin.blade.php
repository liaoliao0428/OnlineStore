			...
			<div class="card shadow-none bg-transparent">
				<div class="card-body p-md-5 text-center">
					...
					<form action="{{route('adminLogin')}}" method="POST">
						<div class="mb-3 mt-3">
						<input type="account" name="account" class="form-control" placeholder="輸入帳號" required="required" />
						</div>
						<div class="mb-3 mt-3">
							<input type="password" name="password" class="form-control" placeholder="輸入密碼" required="required" />
						</div>
						<div class="d-grid">
